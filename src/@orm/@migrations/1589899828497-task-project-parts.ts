...
export class TaskProjectParts1589899828497 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "task_project_parts_project_part" ("taskId" integer NOT NULL, "projectPartId" integer NOT NULL, CONSTRAINT "PK_4f45f466e5a668538497abcba31" PRIMARY KEY ("taskId", "projectPartId"))`,
      undefined
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b6f887cee37a58ddeddbcb98e0" ON "task_project_parts_project_part" ("taskId") `,
      undefined
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0ea64a6f83abf78d27cb1d46f3" ON "task_project_parts_project_part" ("projectPartId") `,
      undefined
    );
    await queryRunner.query(`ALTER TABLE "task" DROP COLUMN "projectPartId"`, undefined);
    await queryRunner.query(
      `ALTER TABLE "task_project_parts_project_part" ADD CONSTRAINT "FK_b6f887cee37a58ddeddbcb98e0a" FOREIGN KEY ("taskId") REFERENCES "task"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
      undefined
    );
    await queryRunner.query(
      `ALTER TABLE "task_project_parts_project_part" ADD CONSTRAINT "FK_0ea64a6f83abf78d27cb1d46f35" FOREIGN KEY ("projectPartId") REFERENCES "project_part"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
      undefined
    );
  }
