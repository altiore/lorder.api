...
export class userWork1540020523468 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_work" ADD CONSTRAINT "FK_a7c71b593da521d2aac44d20ebf" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE cascade ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE "user_work" ADD CONSTRAINT "FK_d8ece38284b7c03f8bce22dd399" FOREIGN KEY ("taskId") REFERENCES "task"("id") ON DELETE cascade ON UPDATE CASCADE`
    );
    await queryRunner.query(
