...
export class ProjectRoleService {
  constructor(
    @InjectRepository(ProjectRoleRepository) private readonly projectRoleRepo: ProjectRoleRepository,
    private readonly projectTaskService: ProjectTaskService
  ) {}

  public async findAll(project: Project, taskId: number, listDto: ListDto, user: User): Promise<ProjectRole[]> {
    await this.projectTaskService.checkAccess(taskId, project, user);
    return [];
  }
