...
export class userEmailTel1527354199560 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query('ALTER TABLE `user` ADD UNIQUE INDEX `IDX_ff716f76b4bf8176aa40d0c87c` (`tel`)');
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query('ALTER TABLE `user` CHANGE `updatedAt` `updatedAt` datetime(6) NOT NULL');
    await queryRunner.query('ALTER TABLE `user` CHANGE `createdAt` `createdAt` datetime(6) NOT NULL');
    await queryRunner.query('ALTER TABLE `user` DROP INDEX `IDX_ff716f76b4bf8176aa40d0c87c`');
